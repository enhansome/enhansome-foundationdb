# awesome-foundationdb with stars

## General

Important links:

* [GitHub repo](https://github.com/apple/foundationdb/) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Python](https://apple.github.io/foundationdb/api-python.html)
  * [Recipes](https://github.com/apple/foundationdb/tree/master/recipes/python-recipes) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Ruby](https://apple.github.io/foundationdb/api-ruby.html)
  * [Recipes](https://github.com/apple/foundationdb/tree/master/recipes/ruby-recipes) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Java](https://apple.github.io/foundationdb/javadoc/index.html)
  * [Recipes](https://github.com/apple/foundationdb/tree/master/recipes/java-recipes) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Go](https://godoc.org/github.com/apple/foundationdb/bindings/go/src/fdb)
  * [Recipes](https://github.com/apple/foundationdb/tree/master/recipes/go-recipes) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Rust](https://github.com/foundationdb-rs/foundationdb-rs) ⭐ 228 | 🐛 55 | 🌐 Rust | 📅 2026-08-24 (@fdb-rs's community)
* [C#/.NET](https://github.com/Doxense/foundationdb-dotnet-client) ⭐ 158 | 🐛 15 | 🌐 C# | 📅 2026-08-27 (@Doxense)
...
* [Clojure](https://github.com/vedang/clj_fdb) ⭐ 27 | 🐛 8 | 🌐 Clojure | 📅 2022-12-19 (@vedang)
* [TypeScript](https://github.com/openland/foundationdb) ⚠️ Archived (@openland)
* [Scala](https://github.com/pwliwanow/foundationdb4s) ⭐ 27 | 🐛 17 | 🌐 Scala | 📅 2024-08-13 (@pwliwanow)
* [Clojure](https://github.com/tirkarthi/clj-foundationdb) ⭐ 20 | 🐛 3 | 🌐 Clojure | 📅 2019-04-12 (@tirkarthi)
* [Clojure Record-Layer](https://github.com/exoscale/vinyl) ⭐ 17 | 🐛 1 | 🌐 Clojure | 📅 2026-08-04 (@exoscale)
* [Clojure](https://github.com/alex-dixon/clj-foundationdb) ⭐ 6 | 🐛 0 | 🌐 Clojure | 📅 2018-08-04 (@alex-dixon)
* [Julia](https://github.com/tanmaykm/FoundationDB.jl) ⭐ 4 | 🐛 0 | 🌐 Julia | 📅 2019-01-10 (@tanmaykm)
* [Python asyncio](https://github.com/amirouche/asyncio-foundationdb) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-04-29 (@amirouche)
* [Tokio/Rust](https://fdb-rs.github.io/) (@rajivr)
* [NodeJS](https://www.npmjs.com/package/foundationdb) (@josephg)
  * [Example repo](https://github.com/bbonnin/foundationdb-examples) ⭐ 4 | 🐛 0 | 🌐 CSS | 📅 2013-09-06 (@bbonnin)

## Layers

Experimental/Proof of Concept:

* [Hashicorp Vault](https://github.com/hashicorp/vault/pull/4900) ⭐ 36,181 | 🐛 1,431 | 🌐 Go | 📅 2026-08-28
* [FoundationDB's example Python layers](https://github.com/apple/foundationdb/tree/master/layers) ⭐ 16,650 | 🐛 762 | 🌐 C++ | 📅 2026-08-28
...
* [Query Language](https://github.com/janderland/fql) ⭐ 154 | 🐛 14 | 🌐 Go | 📅 2026-08-28 (@janderland)
* [Python NBD server](https://github.com/dividuum/fdb-nbd) ⭐ 114 | 🐛 0 | 🌐 Python | 📅 2018-04-30 (@dividuum)
...
* [Golang layer](https://github.com/romannikov/fdb-go-layer-plugin) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2026-05-20 (@romannikov)
...
* [DeepSeek Fire-Flyer File System (3FS)](https://github.com/deepseek-ai/3FS) ⭐ 10,169 | 🐛 161 | 🌐 C++ | 📅 2026-05-07
...
* [Database benchmark that includes FDB](https://github.com/pingcap/go-ycsb/) ⭐ 640 | 🐛 73 | 🌐 Go | 📅 2025-12-31 (@pingcap)
* [Terraform deployment PoC](https://github.com/bitgn/fdb-cloud-test) ⭐ 27 | 🐛 0 | 🌐 HCL | 📅 2019-12-18 (@bitgn)
* [Wavefront FDB Tailer](https://github.com/wavefrontHQ/wavefront-fdb-tailer) ⚠️ Archived (@wavefrontHQ)
* [Prometheus exporter](https://github.com/leoluk/fdb_exporter) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2021-05-04 (@leoluk)
...
* [Time Series and FoundationDB: Millions of writes/s and 10x compression in under 2,000 lines of Go](https://github.com/richardartoul/tsdb-layer/blob/master/README.md) ⭐ 522 | 🐛 2 | 🌐 Go | 📅 2019-08-27 (github.com/richardartoul)
...
* [FoundationDB: A Distributed Unbundled Transactional Key Value Store](https://www.micahlerner.com/2021/06/12/foundationdb-a-distributed-unbundled-transactional-key-value-store.html) ([www.micahlerner.com](http://www.micahlerner.com))
...
* [GitHub - jzhou77/flow-examples](https://github.com/jzhou77/flow-examples) ⭐ 17 | 🐛 0 | 🌐 C++ | 📅 2023-06-05 Examples for using Flow language
